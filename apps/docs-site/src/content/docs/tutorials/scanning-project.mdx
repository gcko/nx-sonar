...
This tutorial will demonstrate how to scan a project using the nx-sonar Nx Plugin and upload the results to Sonar

## Prerequisites

1. [Nx workspace](https://nx.dev/getting-started/intro)
2. [nx-sonar](/getting-started#installation)
...
1. Given the existing project to be scanned is named `app`, run the following generator:
   ...
   ```sh
   npx nx g @gcko/nx-sonar:config app
   ```
